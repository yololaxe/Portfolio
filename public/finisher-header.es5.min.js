...
!function (t) {
  ...
  var e = function () {
    ...
    h = function () {
      function h(i) {
        var s = this;
        _ccc(this, h), this.c = document.createElement("canvas"), this.x = this.c.getContext("2d"), this.c.setAttribute("id", "finisher-canvas");
        var elm = this.gr(i && i.className ? i.className : "finisher-header");
        if(elm) {
           elm.appendChild(this.c);
        }
        var e = void 0;
      ...
      return _cc(h, [{
        ...
        value: function (t) {
          ...
          if (!i.length) return document.body;
          return i[0]
        }
      }, {
        key: "resize",
