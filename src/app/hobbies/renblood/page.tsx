...
export default function RenbloodPage() {
  ...
  return (
    <div className="text-slate-200 min-h-screen selection:bg-red-500/30 relative">
      <LanguageToggle />
      ...
      <main className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
           ...
           <div className="relative z-10 p-8 text-center bg-black/60 backdrop-blur-md border border-red-500/30 rounded-xl">
              <h2 className="font-gaming text-2xl text-red-400 tracking-widest mb-2">{t.renblood.teaserTitle}</h2>
              <p className="font-tech text-slate-300 text-lg">{t.renblood.teaserDesc}</p>
           </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
          ...
          >
            <h3 className="text-2xl font-gaming uppercase tracking-wider text-red-400 mb-6">{t.renblood.conceptTitle}</h3>
            <p className="font-tech text-lg text-slate-400 leading-relaxed space-y-4">
              <span className="block">{t.renblood.conceptDesc1}</span>
              <span className="block">{t.renblood.conceptDesc2}</span>
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            className="p-8 sm:p-10 bg-[#111] border border-slate-800 rounded-3xl hover:border-red-500/30 transition-colors"
          >
            <h3 className="text-2xl font-gaming uppercase tracking-wider text-red-400 mb-6">{t.renblood.featuresTitle}</h3>
            <ul className="space-y-4 font-tech text-lg text-slate-300">
              <li className="flex items-center gap-3">
                <span className="w-2 h-2 bg-red-500 rounded-full"></span> {t.renblood.feature1}
              </li>
              <li className="flex items-center gap-3">
                <span className="w-2 h-2 bg-red-500 rounded-full"></span> {t.renblood.feature2}
              </li>
              <li className="flex items-center gap-3">
                <span className="w-2 h-2 bg-red-500 rounded-full"></span> {t.renblood.feature3}
              </li>
            </ul>
          </motion.div>
        </div>
        ...
        >
          <h2 className="text-3xl font-gaming uppercase text-white mb-6">{t.renblood.ctaTitle}</h2>
